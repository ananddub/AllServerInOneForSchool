...
class StdDuesCal {
    ...
    public async setAdmDuesAmt() {
        const tempdata: { duesamt: number }[] = await sqlQuery(
            `SELECT duesamt FROM tbl_admissionfeepmt WHERE admno="${this.admno
    ...
    public async setSessionFee() {
        const tempdata: any = await sqlQuery(
            `SELECT dues FROM tbl_sessionfee WHERE admno="${this.admno
    ...
    public async setStdFee() {
        const tempdata = await sqlQuery(
            `SELECT * FROM tbl_stdfeemaster where admno="${this.admno
    ...
    public async setBasicDetail() {
        const q = `select admno,name,fname,fmob,class,roll,section,session,transport,hostel from tbl_admission where admno = "${this.admno
    ...
    public async setMonthFee() {
        this.monthfee = [];
        const query = `SELECT * FROM tbl_monthfee  WHERE admno="${this.admno
            }" AND session="${this.curSession()}";`;
    ...
    public async setTransFee() {
        this.transfee = [];
        const query = `SELECT * FROM tbl_transportfee  WHERE admno="${this.admno
            }" AND session="${this.curSession()}";`;
    ...
    public async setHostelFee() {
        this.hostelfee = [];
        const query = `SELECT * FROM tbl_hostelfee  WHERE admno="${this.admno
            }" AND session="${this.curSession()}";`;
        const data: any[] = await sqlQuery(query);
