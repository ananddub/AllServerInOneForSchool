...
import { getAdminTeacherDetail, getTImage, getTeacherAttendance, marksAttendance } from "./components/HTTPSERVER/Attendance/attendance";
...
app.get("/teacher/getImage", getTImage);
app.post(
    "/documents",
